...
[P1641R3](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p1641r3.html)や[P1642R3](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p1642r3.html)の以前のリビジョンで同時に提案されていたものを分離した提案です。
...
2つの型が同じではない、2つの型は類似の型（*similar type*）である、あるいは2つの型は類似していない、という事を表現する3つの新しいコンセプトを追加する提案。
