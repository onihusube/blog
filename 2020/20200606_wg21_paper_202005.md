...
[Numbers TS](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p1889r1.pdf)に対して、10進多倍長浮動小数点型`std::decimal`を追加する提案。

[P1889R1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2020/p1889r1.pdf)は将来C++に導入することを目指したNumerics関連の提案をまとめたもので、多倍長整数型などが提案されています。現状10進浮動小数点型は無いようなので追加しようということのようです。
