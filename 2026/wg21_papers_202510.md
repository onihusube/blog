...
- アキュムレータオブジェクトはより検討を行うために将来の提案に延期
- P2681から共分散の計算を導入
...
- [P3086R4 Proxy: A Pointer-Semantics-Based Polymorphism Library - WG21月次提案文書を眺める（2025年05月）](https://onihusube.hatenablog.com/entry/2025/04/20/205527#P2728R7-Unicode-in-the-Library-Part-1-UTF-Transcoding)
...
- transversal categoryのセクションに、イテレータのスタッシュ、ムーブのみの型、`scan_view`における無条件`input_range`と条件付き`forward_range`の選択に関する議論などを追加
...
constexpr const CharT* __statically_widen(const char* __str, const wchar_t* __wstr) {
