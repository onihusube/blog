...
- [@yaito3014さん](https://twitter.com/yaito3014/status/1393186084712960003)
...
- [@kariya_mitsuruさん](https://twitter.com/kariya_mitsuru/status/1387086078453055490)
- [@yohhoyさん](https://twitter.com/yohhoy/status/1387305463021146115)
...
- [ISO-IEC-JTC1-SC22-WG23-CPP/wg23-tr24772-10-public](https://github.com/ISO-IEC-JTC1-SC22-WG23-CPP/wg23-tr24772-10-public)
...
このリビジョンでの変更は、機能テストマクロを`__cpp_lib_constexpr_memory`をバージョンアップするように変更したことと、`nullptr`に対しても`constexpr`で`swap`、比較と`default_deleter`が機能するようにしたことです。
...
`fold`の戻り値型の問題は次のようなコードで結果がどうなるのかという事です。
...
この場合に、`ranges::fold`の戻り値型を`U = std::decay_t<std::invoke_result_t<F&, T, ranges::range_reference_t<R>>`の様に決めることで戻り値型が初期値から決まらないようにしています。それに伴って必要な制約を追加して、この提案では上記の`r`は`double`の`2.0`になります。
...
![](https://raw.githubusercontent.com/onihusube/blog/master/2021/20210514_wg21_paper_202104/P2337R0_incorect_round.png)  
...
- [@Reputelessさん](https://twitter.com/Reputeless/status/1393191363026440196)
